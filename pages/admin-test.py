...
BRAND_COLORS = {
    ...
    "dark": "#1C1C1E",   # iOS System Background
    "gray": "#8E8E93",   # iOS System Gray
    "light_gray": "#2C2C2E" # iOS Secondary Fill
}

# --- 3. CSS STYLING (iOS 26 Design System) ---
st.markdown(f"""
    <style>
        ...
        .custom-card, div[data-testid="stContainer"] {{
        ...
        /* HERO SECTION (Apple Wallet Style) */
        .hero-box {{
        ...
        /* NAVIGATION BUTTONS (Control Center Widgets) */
        ...
        .login-title {{ color: var(--primary) !important; font-size: 2rem; font-weight: 800; margin-bottom: 10px; }}
        ...
        .stTabs [aria-selected="true"] {{
            background-color: var(--ios-widget);
            color: white;
