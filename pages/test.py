...
# --- 2. CSS STYLING (Apple-inspired / Human Interface-ish) ---
st.markdown(
    """
<style>
/* ---------------------------------------------------------
   Apple-inspired UI for Streamlit (iOS/macOS feel)
   - System SF font stack (no webfont needed)
   - Frosted glass surfaces (backdrop-filter)
   - Hairline borders, subtle shadows
   - iOS blue accent
--------------------------------------------------------- */
...
:root{
  ...
  --border: rgba(60,60,67,0.14); /* iOS separator */
  ...
  --shadow-1: 0 1px 2px rgba(0,0,0,0.06), 0 6px 18px rgba(0,0,0,0.06);
  --shadow-2: 0 10px 30px rgba(0,0,0,0.10), 0 2px 8px rgba(0,0,0,0.06);
  ...
  --focus: 0 0 0 4px rgba(0,122,255,0.20);
...
@media (prefers-color-scheme: dark) {
  :root{
    ...
    --shadow-1: 0 1px 2px rgba(0,0,0,0.45), 0 10px 30px rgba(0,0,0,0.30);
    --shadow-2: 0 16px 40px rgba(0,0,0,0.45), 0 6px 18px rgba(0,0,0,0.30);
  }
}
...
/* Global typography: SF system stack */
html, body, [class*="css"]{
  font-family: -apple-system, BlinkMacSystemFont, "SF Pro Text", "SF Pro Display",
               "Helvetica Neue", Helvetica, Arial, system-ui, sans-serif !important;
  color: var(--text);
}
...
.stApp{
  background:
    radial-gradient(1200px 600px at 20% -10%, rgba(0,122,255,0.12), transparent 60%),
    radial-gradient(900px 500px at 85% 5%, rgba(52,199,89,0.10), transparent 55%),
    var(--bg);
  background-attachment: fixed;
}

/* Frosted main container */
.block-container{
  max-width: 860px;
...
/* Radio group -> iOS-like segmented control */
.stRadio{ background: transparent; padding: 0; }
...
/* Selected option styling (modern browsers) */
.stRadio [role="radiogroup"] label:has(input[type="radio"]:checked){
  background: rgba(0,122,255,0.16);
  border: 1px solid rgba(0,122,255,0.22);
}
.stRadio [role="radiogroup"] label:has(input[type="radio"]:checked) span{
  color: var(--text);
}
...
@media (prefers-color-scheme: dark){
  .score-container{ background-color: rgba(255,255,255,0.10); }
}
.score-fill{
  height: 100%;
  border-radius: 999px;
  background: linear-gradient(90deg, rgba(0,122,255,1), rgba(52,199,89,1));
...
ROLE_RELATIONSHIP_LABELS = {
    "Program Supervisor": {
        ...
        "leadershipLabel": "agency leadership",
    },
    "Shift Supervisor": {
        "directReportsLabel": "YDPs",
        "youthLabel": "youth you support",
        "supervisorLabel": "Program Supervisor",
        "leadershipLabel": "agency leadership",
    },
    "YDP": {
        "directReportsLabel": "peers",
        "youthLabel": "youth in your care",
        "supervisorLabel": "Shift Supervisor",
        "leadershipLabel": "Program Supervisor",
    },
}
...
COMM_QUESTIONS = [
    {
        "id": "comm1",
        "text": "When a situation becomes chaotic, I naturally step in and start directing people toward a plan.",
        "style": "Director",
    },
    {
        "id": "comm2",
        "text": "I feel most effective when I can make quick decisions and move the team forward.",
        "style": "Director",
    },
    {
        "id": "comm3",
        "text": "In a crisis, I’d rather take charge and apologize later than wait too long for consensus.",
        "style": "Director",
    },
    {
        "id": "comm4",
        "text": "If expectations are unclear, I tend to define them myself and communicate them to others.",
        "style": "Director",
    },
    {
        "id": "comm5",
        "text": "I’m comfortable giving direct feedback, even when it may be hard for someone to hear.",
        "style": "Director",
    },
    {
        "id": "comm6",
        "text": "I pay close attention to the emotional tone of the team and lift people up when morale is low.",
        "style": "Encourager",
    },
    {
        "id": "comm7",
        "text": "I often use encouragement, humor, or positive energy to help staff get through hard shifts.",
        "style": "Encourager",
    },
    {
        "id": "comm8",
        "text": "I notice small wins and like to name them out loud so people know they’re seen.",
        "style": "Encourager",
    },
    {
        "id": "comm9",
        "text": "I tend to talk things through with people rather than just giving short instructions.",
        "style": "Encourager",
    },
    {
        "id": "comm10",
        "text": "I’m often the one coworkers come to when they need to vent or feel understood.",
        "style": "Encourager",
    },
    {
        "id": "comm11",
        "text": "I’m good at slowing conversations down so that different perspectives can be heard.",
        "style": "Facilitator",
    },
    {
        "id": "comm12",
        "text": "I try to stay calm and balanced when others are escalated or upset.",
        "style": "Facilitator",
    },
    {
        "id": "comm13",
        "text": "I often find myself summarizing what others are saying to move toward shared understanding.",
        "style": "Facilitator",
    },
    {
        "id": "comm14",
        "text": "I prefer to build agreement and buy-in rather than rely only on authority.",
        "style": "Facilitator",
    },
    {
        "id": "comm15",
        "text": "I pay attention to process (how we talk to each other) as much as the final decision.",
        "style": "Facilitator",
    },
    {
        "id": "comm16",
        "text": "I naturally notice details in documentation, routines, or schedules others overlook.",
        "style": "Tracker",
    },
    {
        "id": "comm17",
        "text": "I feel responsible for keeping procedures on track, even when others get distracted.",
        "style": "Tracker",
    },
    {
        "id": "comm18",
        "text": "I tend to ask clarifying questions when expectations or instructions feel vague.",
        "style": "Tracker",
    },
    {
        "id": "comm19",
        "text": "I’m more comfortable when I know exactly who is doing what and when it needs to be done.",
        "style": "Tracker",
    },
    {
        "id": "comm20",
        "text": "If something seems out of compliance, it really sticks with me until it’s addressed.",
        "style": "Tracker",
    },
]
...
MOTIVATION_QUESTIONS = [
    {
        "id": "mot1",
        "text": "I feel energized when I’m learning new skills or being stretched in healthy ways.",
        "style": "Growth",
    },
    {
        "id": "mot2",
        "text": "It’s important to me that I can look back and see I’m becoming more effective over time.",
        "style": "Growth",
    },
    {
        "id": "mot3",
        "text": "When I feel stuck in the same patterns with no development, my motivation drops.",
        "style": "Growth",
    },
    {
        "id": "mot4",
        "text": "I appreciate feedback that helps me improve, even if it’s uncomfortable in the moment.",
        "style": "Growth",
    },
    {
        "id": "mot5",
        "text": "Access to training, coaching, or new responsibilities matters a lot for my commitment.",
        "style": "Growth",
    },
    {
        "id": "mot6",
        "text": "I need to feel that what I’m doing connects to a bigger purpose for youth and families.",
        "style": "Purpose",
    },
    {
        "id": "mot7",
        "text": "I feel strongest when my work lines up with my values about dignity, justice, and safety.",
        "style": "Purpose",
    },
    {
        "id": "mot8",
        "text": "It’s hard for me to stay engaged when policies don’t make sense for the youth we serve.",
        "style": "Purpose",
    },
    {
        "id": "mot9",
        "text": "I’m often the one raising questions about whether a decision is really best for kids.",
        "style": "Purpose",
    },
    {
        "id": "mot10",
        "text": "I feel proudest when I can see real positive impact, not just tasks checked off.",
        "style": "Purpose",
    },
    {
        "id": "mot11",
        "text": "Having strong relationships with coworkers makes a big difference in my energy.",
        "style": "Connection",
    },
    {
        "id": "mot12",
        "text": "When the team feels disconnected, I feel it in my body and it’s harder to stay motivated.",
        "style": "Connection",
    },
    {
        "id": "mot13",
        "text": "I value feeling known and supported by my team and supervisor, not just evaluated.",
        "style": "Connection",
    },
    {
        "id": "mot14",
        "text": "I’m often thinking about the emotional climate of the unit and how people are relating.",
        "style": "Connection",
    },
    {
        "id": "mot15",
        "text": "I’m more likely to go above and beyond when I feel a sense of belonging.",
        "style": "Connection",
    },
    {
        "id": "mot16",
        "text": "I like having clear goals and being able to see, in concrete ways, when we’ve met them.",
        "style": "Achievement",
    },
    {
        "id": "mot17",
        "text": "I feel satisfied when I can see that that my effort led to specific improvements.",
        "style": "Achievement",
    },
    {
        "id": "mot18",
        "text": "It’s frustrating when expectations keep shifting and I’m not sure what success looks like.",
        "style": "Achievement",
    },
    {
        "id": "mot19",
        "text": "I appreciate data, tracking tools, or simple dashboards that help show progress.",
        "style": "Achievement",
    },
    {
        "id": "mot20",
        "text": "I’m motivated by being trusted with projects where outcomes are clearly defined.",
        "style": "Achievement",
    },
]
...
def generate_text_report(user_info, results, comm_prof, mot_prof, int_prof, role_key, role_labels):
    lines = [
        f"Elmcrest Leadership Compass PROFILE FOR {user_info['name'].upper()}",
        "=" * 40,
        "",
    ]
    ...
    if int_prof:
        ...
        for s in int_prof["strengths"]:
            lines.append(f"- {s}")
        lines.append("\nWEAKNESSES:")
        for w in int_prof["weaknesses"]:
            lines.append(f"- {w}")
        lines.append("\nCOMMUNICATION ARCHITECTURE:")
        for ca in int_prof["comm_arch"]:
            lines.append(f"- {ca}")
        lines.append("\nSTRATEGIC DEVELOPMENT ROADMAP:")
        for r in int_prof["roadmap"]:
            lines.append(f"- {r}")
...
def create_pdf(user_info, results, comm_prof, mot_prof, int_prof, role_key, role_labels):
    ...
    pdf.cell(
        0,
        8,
        clean_text(f"Prepared for: {user_info['name']} | Role: {user_info['role']}"),
        ln=True,
        align="C",
    )
    pdf.ln(5)
    ...
    overview_text = (
        comm_prof["overview"].replace("<strong>", "").replace("</strong>", "").replace("<br><br>", "\n\n")
    )
    ...
    if int_prof:
        ...
        pdf.set_font("Arial", "", 11)
        for s in int_prof["strengths"]:
            pdf.multi_cell(0, 6, clean_text(f"- {s.replace('**', '')}"))
        pdf.ln(2)
        ...
        pdf.set_font("Arial", "", 11)
        for w in int_prof["weaknesses"]:
            pdf.multi_cell(0, 6, clean_text(f"- {w.replace('**', '')}"))
        pdf.ln(2)
        ...
        pdf.set_font("Arial", "", 11)
        for c in int_prof["comm_arch"]:
            pdf.multi_cell(0, 6, clean_text(f"- {c.replace('**', '')}"))
        pdf.ln(2)
        ...
        pdf.set_font("Arial", "", 11)
        for r in int_prof["roadmap"]:
            pdf.multi_cell(0, 6, clean_text(f"- {r.replace('**', '')}"))
...
if st.session_state.step == "intro":
    ...
    st.markdown("#### 👋 Welcome")
    st.info(
        "This assessment helps you understand your natural patterns at work. Your insights will shape a personalized profile built to support your growth."
    )
    ...
    with st.form("intro_form"):
        ...
        role = c3.selectbox(
            "Current Role",
            ["Program Supervisor", "Shift Supervisor", "YDP"],
            index=None,
            placeholder="Select your role...",
        )
        cottage = c4.selectbox(
            "Home Program",
            ["Cottage 2", "Cottage 3", "Cottage 8", "Cottage 9", "Cottage 11", "Overnight"],
            index=None,
    ...
    with st.form("comm_form"):
        ...
        for i, q in enumerate(st.session_state.shuffled_comm):
            with st.container(border=True):
                ...
                with col_q:
                    st.markdown(
                        f"<div class='question-text' style='display:flex;align-items:center;height:100%;'>{i+1}. {q['text']}</div>",
                        unsafe_allow_html=True,
                    )
...
# --- PROCESSING ---
    ...
    for q in COMM_QUESTIONS:
        c_scores[q["style"]] += st.session_state.answers_comm[q["id"]]
    for q in MOTIVATION_QUESTIONS:
        m_scores[q["style"]] += st.session_state.answers_motiv[q["id"]]
...
# --- RESULTS ---
    ...
    st.markdown(
        f"""
    <div class="info-card">
        <div style="color: var(--text-2); font-weight: 800; margin-bottom: 6px; text-transform: uppercase; font-size: 0.78rem; letter-spacing: 0.08em;">
            {comm_prof['tagline']}
        </div>
